...
| # | Веха | Ветка | Статус | PR | Примечания |
|---|------|-------|--------|-----|------------|
...
| 8 | 1:1 Video calls — basic WebRTC | — | backlog | — | Enable `experimentalVoip`, audit VoIP code |
| 9 | Video calls — NAT traversal / TURN | — | backlog | — | Depends on milestone 8; TURN server ready |
| 10 | Video calls — push & background | — | backlog | — | CallKit (iOS), foreground service (Android) |
| 11 | Stabilization & testing | — | backlog | — | Regression testing, edge cases, multi-device |
| 12 | Beta release | — | backlog | — | TestFlight + Google Play closed testing |
